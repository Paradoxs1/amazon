 ...
 */
final class Version20180717154116 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE crawling_url DROP product_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE crawling_url ADD product_id INT DEFAULT NULL');
